...
import (
	...
	"github.com/spectre-project/spectred/infrastructure/os/signal"
...
// Start starts the spectrewalletd server
func Start(params *dagconfig.Params, listen, rpcServer string, keysFilePath string, profile string, timeout uint32) error {
	...
	pb.RegisterSpectrewalletdServer(grpcServer, serverInstance)
